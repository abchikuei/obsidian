...
| ----- | ------------------------------ | ---------------------------------------------------------------------------------------------------------------------------- | --------- |
| **1** | **🛠️ Software Engineering**   | Best practices, design patterns, programming languages, frameworks, libraries, APIs, devops, and system design               | **`#SE`** |
